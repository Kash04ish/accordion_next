  ...
  return (
    <div className="w-3/4 mx-auto mt-2">
      <div
        ...
        className="flex group cursor-pointer justify-between items-center p-3 mb-5 rounded-md bg-white border border-gray-300"
      >
        <div className="flex group cursor-pointer">
          <div className="text-black-600 font-semibold pl-10">{title}</div>
        </div>
